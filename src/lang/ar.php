...
'portail_intro' => 'متابعة المشاريع العمرانية وتوثيقها ومناقشتها، مدينةً مدينة. البوّابة تنشر، والمنتدى يناقش.',
'portail_une' => 'في الواجهة',
'portail_actualites' => 'الأخبار',
'portail_derniers' => 'أحدث المقالات',
'portail_rubriques' => 'الأبواب',
'portail_rubrique' => 'الباب',
'portail_rubrique_vide' => 'لا مقالات في هذا الباب بعد.',
'portail_aucun_article' => 'لم يُنشر أي مقال بعد.',
'portail_aucun_article_aide' => 'البوّابة جاهزة وفارغة، وهذه حال أي موقع في يوم افتتاحه. الأبواب واللغات وخلاصة الأخبار والبحث تعمل جميعها؛ تنقص النصوص وحدها.',
'portail_ecrire' => 'كتابة مقال',
'portail_tout_voir' => 'عرض الكل',
'portail_forum_recent' => 'في المنتدى',
'portail_villes' => 'التصفّح حسب المدينة',
'portail_chiffres' => 'المنصّة بالأرقام',
'portail_articles' => 'مقالات',
'portail_par' => 'بقلم',
'portail_flux' => 'خلاصة RSS',
'portail_filtre_langue' => 'لغة المقال',
'portail_toutes_langues' => 'كل اللغات',
'portail_sources' => 'المصادر',
'portail_sources_aide' => 'الميزانية والارتفاع وتاريخ التسليم وقائع، لا تقديرات. إمّا أن تأتي من مصدر أو لا تُكتب.',
'portail_sources_enregistrees' => 'المصادر المسجّلة',
'portail_sans_source' => 'لا يستند هذا المقال إلى أي مصدر.',
'portail_sans_source_aide' => 'هذا التنبيه معروض عن قصد: المقال بلا مصدر يجب أن يظهر كذلك، لا أن يبدو معلومة موثّقة.',
'portail_source_url' => 'عنوان المصدر',
'portail_source_titre' => 'عنوان المرجع',
'portail_source_editeur' => 'الناشر',
'portail_retirer' => 'إزالة',
'portail_aussi_en' => 'متاح أيضًا بـ:',
'portail_discuter_titre' => 'للنقاش',
'portail_discuter_aide' => 'فتح النقاش يُنشئ موضوعًا في منتدى المدينة المعنيّة. لا يُنسخ المقال هناك، بل يشير إليه الموضوع.',
'portail_discuter_connexion' => 'يلزم حساب لفتح النقاش. أمّا القراءة فلا تتطلّب شيئًا.',
'portail_ouvrir_discussion' => 'فتح النقاش',
'portail_suivre_discussion' => 'الانضمام إلى النقاش',
'portail_discussion_ouverte' => 'النقاش مفتوح: {n} ردّ.',
'portail_a_lire' => 'اقرأ أيضًا',
'portail_brouillon_avis' => 'معاينة — هذا المقال غير منشور (الحالة: {etat}). هذه الصفحة يراها المحرّرون وحدهم ولا تُفهرَس.',
'portail_programme_avis' => 'مُبرمَج — سيظهر هذا المقال في {date}. حتى ذلك الحين يردّ هذا العنوان بـ404 للعموم.',

/* portail — rédaction */
'portail_gestion' => 'إدارة البوّابة',
'portail_nouvel_article' => 'مقال جديد',
'portail_modifier' => 'تعديل المقال',
'portail_apercu' => 'معاينة',
'portail_tous' => 'الكل',
'portail_aucun_brouillon' => 'لا مقالات بهذا المرشّح.',
'portail_titre' => 'العنوان',
'portail_titre_obligatoire' => 'لا بدّ للمقال من عنوان: منه يُشتقّ الرابط ومسار التصفّح وعنوان التبويب.',
'portail_chapeau' => 'المقدّمة',
'portail_chapeau_aide' => 'جملتان أو ثلاث. هي ما يظهر في القوائم وفي الخلاصة وفي نتائج البحث. إن تُركت فارغة أُخذت من بداية النص.',
'portail_langue' => 'لغة المقال',
'portail_langue_aide' => 'يُكتب المقال بلغة واحدة. لا تُولَّد أي ترجمة آليًا؛ نسخ الموضوع الواحد يرتبط بعضها ببعض.',
'portail_ville' => 'المدينة',
'portail_ville_aide' => 'يُستنتج البلد والقارة من المدينة. هذا الربط هو ما يُظهر المقال في صفحة المدينة وما يختار منتدى النقاش.',
'portail_sans_ville' => 'بلا مدينة',
'portail_sans_rubrique' => 'بلا باب',
'portail_signature' => 'التوقيع',
'portail_signature_aide' => 'يظهر بدل اسم المستخدم عند تعبئته. مفيد للتوقيع باسم هيئة تحرير أو مراسل.',
'portail_publication' => 'النشر',
'portail_statut' => 'الحالة',
'portail_statut_brouillon' => 'مسوّدة',
'portail_statut_publie' => 'منشور',
'portail_statut_retire' => 'مسحوب',
'portail_statut_programme' => 'مُبرمَج',
'portail_sans_droit_publier' => 'هذا الحساب يكتب ويحفظ ولا ينشر. يُحفظ المقال كمسوّدة.',
'portail_date_publication' => 'تاريخ النشر (UTC)',
'portail_date_aide' => 'الصيغة سنة-شهر-يوم ساعة:دقيقة بتوقيت UTC. التاريخ في المستقبل يُبرمج المقال: يبقى غير مرئي، حتى عبر رابطه المباشر، إلى حين الموعد.',
'portail_une_case' => 'رفعه إلى الواجهة',
'portail_rang_une' => 'ترتيبه في الواجهة',
'portail_disc_amorce' => 'نقاش مفتوح حول مقال «{titre}».',

/* divers */
'demo_etiquette' => 'عرض',
'nav_communaute' => 'المجتمع',
'rech_dans_portail' => 'البوّابة',
'rech_filtrer' => 'تصفية',
'portail_n_articles_un' => 'مقال واحد',
'portail_n_articles_autre' => '{n} مقالات',
'portail_n_vues_un' => 'مشاهدة واحدة',
'portail_n_vues_autre' => '{n} مشاهدات',
'portail_corps' => 'نص المقال',
'role_redacteur' => 'محرّر',
];
